...
var solve = function() {
  ...
  // Исследуем диагональное преобладание
  // 
  // var matrix = [
  //   [ 4.646128, 1.2778591, -3.2868475],
  //   [ 1.2778591, 2.0844645,  0.76474173],
  //   [-3.2868475, 0.76474173, 6.4147487]
  // ];
  // var matrix = [
  //   [ 4.646128, 1.2778591, -3.2868475],
  //   [ 1.2778591, 2.0844645,  0.76474173],
  //   [-3.2868475, 0.76474173, 5.4147487]
  // ];
  // var matrix = [
  //   [ 4.646128, 1.2778591, -3.2868475],
  //   [ 1.2778591, 2.0844645,  0.76474173],
  //   [-3.2868475, 0.76474173, 4.4147487]
  // ];

  // Устремим матрицу к диагональной
  // 
  // var matrix = [
  //   [ 106.46128, 1.2778591, -3.2868475],
  //   [ 1.2778591, 80.844645,  0.76474173],
  //   [-3.2868475, 0.76474173, 64.147487]
  // ];
  // var matrix = [
  //   [ 1064.6128, 1.2778591, -3.2868475],
  //   [ 1.2778591, 808.44645,  0.76474173],
  //   [-3.2868475, 0.76474173, 641.47487]
  // ];
